    ...
    <header class="header">
      <nav class="nav">
        ...
        <ul class="nav__links">
          ...
          <li class="nav__item">
            <a class="nav__link" href="#section--4">Cards</a> 
          </li>
          <li class="nav__item">
            <a class="nav__link" href="#section--3">Status</a>
          </li>
        ...
        <li class="nav__item"><?php
              if(isset($_SESSION['auth']))
              {
                ...
                ?> <a style="text-decoration: none" class="btn btn-dark" href="account.php">CREATE AN ACCOUNT</a>
             <?php } ?>
          </li>
        <li class="nav__item">
    ...
    <footer class="footer">
      ...
      <p class="footer__copyright">
        ...
        <a
          ...
          target="_blank"
          href="https://github.com/capybara2510"
          >Faiz Ayyub</a
        >
      </p>
    </footer>
